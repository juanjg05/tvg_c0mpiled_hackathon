...
export default function Hero() {
  ...
  return (
    <section className="relative flex h-[70vh] min-h-[500px] flex-col items-center justify-center overflow-hidden bg-background">
      {/* Angled Hazard Accents */}
      <div className="absolute top-0 right-0 w-32 h-32 corner-hazard-tr opacity-20 pointer-events-none" />
      <div className="absolute top-0 left-0 w-32 h-32 corner-hazard-tl opacity-20 pointer-events-none" />
      ...
      <div className="absolute bottom-0 left-0 right-0 h-8 bg-hazard opacity-80" style={{ "--hazard-angle": "90deg" } as any} />
      <div className="absolute bottom-8 left-0 right-0 h-[1px] bg-accent/20" />
    </section>
  );
}
